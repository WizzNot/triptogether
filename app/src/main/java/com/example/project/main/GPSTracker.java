...
public class GPSTracker extends Service implements LocationListener {               //Класс определяющий местоположение. Запрашивает разрешение
    // The minimum distance to change Updates in meters                             //найден в интернете
